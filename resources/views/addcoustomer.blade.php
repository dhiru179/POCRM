...
{{-- {{$errors}} --}}
        <form class="px-3 " action="{{route('saveCoustomer')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="col-8 offset-2 mt-3">
                <div class="form-group row mb-3 utils_center">
                    <label for="" class="col-2 col-form-label p-0">Name</label>
                    <div class="col-8">
                        <input type="text" class="form-control rounded-0" name="name" value="{{$customer->customer_name}}" required>
                ...
                <div class="form-group row mb-3 utils_center">
                    ...
                    <div class="col-8">
                        <input type="email" class="form-control rounded-0" name="email" value="{{$customer->email}}">
                ...
                <div class="form-group row mb-3 utils_center">
                    ...
                    <div class="col-8">
                        <input type="text" class="form-control rounded-0" name="phone" value="{{$customer->phone}}" >
                ...
                <div class="form-group row mb-3 utils_center">
                    ...
                    <div class="col-8">
                        <textarea type="text" class="form-control rounded-0" name="address" row='2' >{{$customer->address}}</textarea>
