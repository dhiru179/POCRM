                        ...
                        @foreach ($seller as $key => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('admin/seller_') }}{{ urlencode('view' . '_' . $item->id) }}"
                                        title="View" class="btn btn-primary btn-sm rounded-0"><i class="fa fa-eye"
                                            aria-hidden="true"></i></a>
                                    <a href="{{ url('admin/seller_') }}{{ urlencode('edit' . '_' . $item->id) }}"
                                        title="Edit" class="btn btn-warning btn-sm rounded-0"><i
                                            class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    {{-- <a href="{{ url('admin/seller_') }}{{urlencode('delete'.'_'.$item->id)}}" title="Delete" class="btn btn-danger btn-sm rounded-0"><i class="fa fa-trash-o"
                                        aria-hidden="true"></i></a> --}}
                                </td>
